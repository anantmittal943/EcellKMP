...
data class AccountDTO(
    ...
    val access_type: String = AppConfig.FirebaseConfig.USER_ACCESS,
    val account_type: String = AppConfig.FirebaseConfig.USER_ACCOUNT,
    val linkedin_url: String = "",
    val phone_number: String = "",
    val portfolio_url: String = "",
    val instagram_url: String = "",
    val position: String = "",
    val status: String = AppConfig.FirebaseConfig.STATUS_PENDING,
